...
3. проверить регистрацию сиделки и клиента, отправку анкеты, модерацию и видимость одобренной анкеты в реальном проекте;
4. отдельно выполнить `flutter build appbundle` и проверку на Android-устройстве.
